...
export const AllFilmsDocument = gql`
  ...
  allFilms {
    ...
    `;
export type AllFilmsComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<AllFilmsQuery, AllFilmsQueryVariables>, 'query'>;

    export const AllFilmsComponent = (props: AllFilmsComponentProps) => (
      <ApolloReactComponents.Query<AllFilmsQuery, AllFilmsQueryVariables> query={AllFilmsDocument} {...props} />
    );
